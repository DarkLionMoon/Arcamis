// Icons SVG (stile Lucide/Feather, stroke 24x24) usati dalla shell admin.
// Ogni voce contiene il markup interno dell'SVG; il componente VIcon fornisce l'elemento <svg>.
...
export const icons: Record<string, string> = {
  ...
  carousel:
    '<rect x="3" y="3" width="18" height="18" rx="2"></rect><circle cx="9" cy="9" r="2"></circle><path d="m21 15-3-3-4 4-3-3-6 6"></path>',
  navigate:
  ...
  orphan:
    '<line x1="2" y1="2" x2="22" y2="22"></line><path d="M10.41 10.41a2 2 0 1 1-2.83-2.83"></path><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h1"></path>',
  backup:
